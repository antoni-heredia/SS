...
int main(int argc, char *argv[])
{
    ...
    if (argc < 6)
    {
        ...
        printf("%s  <cantidad maxima pedida>  <dias a simular> <tipo de tabla [a,b,c]> <beneficio por unidad> <perdida por unidad> \n", argv[0]);
        exit(-1);
    }
    ...
    for (int s = 1; s <= cant_maxima; s++)
    {
        ...
        for (int h = 0; h < veces; h++)
        {
            ...
            if (s > demanda)
            {
                ganancia = demanda*beneficio-(s-demanda)*perdida;
            }else
            {
